...
// 根据数据量猜解法  分治  从左到右的尝试模型（但是用这个方法会超时，还是要用分治）
public class Code01_PickBands {
    ...
    // 递归出结果，思路和暴力递归一样，每一个项目都有两种选择，选或者不选
