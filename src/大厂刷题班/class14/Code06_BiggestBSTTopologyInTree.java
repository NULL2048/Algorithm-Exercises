...
// 二叉树递归套路
// 这个题和以往二叉树递归套路的所有提唯一的区别就是，以前的题就是收集到左右子树的信息，然后整合出自己的答案，将自己的答案向上返回，左右子树的信息就都丢掉了
// 但是这个题左右子树的信息也要存起来，比如存在一个map中，所有节点整合出来的信息都要保留，在最后要对所有节点的结果求一个max
...
public class Code06_BiggestBSTTopologyInTree {
